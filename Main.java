...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        AsistenPraktikum_3009[] ap = new AsistenPraktikum_3009[1];
        StudentStaff_3009[] ss = new StudentStaff_3009[1];
        
        ap[0] = new AsistenPraktikum_3009();
        ss[0] = new StudentStaff_3009();
        ...
        try {
            ...
            for(AsistenPraktikum_3009 AP : ap){
